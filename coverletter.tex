...
\setkomavar{fromname}{Masataro Asai, Ph.D} % Your name
\setkomavar{fromaddress}{60 Cross St. E APT224 Somerville 02145, MA, USA} % Your address
\setkomavar{fromphone}{+1-857-999-5722} % Your phone number
\setkomavar{fromemail}{guicho2.71828@gmail.com} % Your email address
\setkomavar{place}{Somerville} % City written before the date, put your city here if you want this
\setkomavar{signature}{Masataro Asai} % Your name as you want it to appear in the signature
\def\position{POSITION} % position name
\def\company{COMPANY} % position name
...
Please find enclosed my CV in application for the position of \position.
 Among the list of projects posted on ({\small
...
My open sourced projects % are publicly hosted on github and
