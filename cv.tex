...
\small
 ...
 +1-857-999-5722 | guicho2.71828@gmail.com | He/him | \href{https://scholar.google.com/citations?user=b4UzH5AAAAAJ}{Google scholar id: b4UzH5AAAAAJ} | \href{https://dblp.uni-trier.de/pid/149/1319.html}{dblp}
...
with an emphasis on Bayesian generative modeling (e.g., variational inference). This includes:
(1) \red{Automatic identification of discrete structured representation for planning}, i.e.,
symbol grounding and knowledge acquisition.
(2) \blue{Learning a search policy / heuristics} for faster problem solving.
...
\begin{CV}
 ...
 JSPS Grant-in-Aid for JSPS Fellows and a JSPS KAKENHI grant, Project No. 16J10073.
 % 1,900,000 JPY % not helping, too small
\end{CV}
...
\begin{CV}
 \item[2024]
 Carlos N{\'u}{\~n}ez-Molina$^*$, Universidad de Granada (Ph.D)
 \item[2025]
 Amin Seffo, Technical University of Munich,  (M.Sc)
 \item[2025]
...
\section{Most Recent Publications / Preprints}
