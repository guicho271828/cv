...
\begin{figure}[h]
 \centering
 \includegraphics[width=0.8\textwidth]{img/static/mnist.png}
...
\begin{figure}[h]
 \centering
 \includegraphics[width=\textwidth]{img/static/lenna.png}
 \caption{Result of solving Lenna-8-puzzle using Deep Neural Network and Classical Planner. \textbf{It does not need reward function nor expert solution trace.}}
\end{figure}
% 
% \begin{figure}[h]
%  \centering
%  \includegraphics[width=\textwidth]{img/static/lightsout.png}
%  \includegraphics[width=\textwidth]{img/static/lightsout-rounded.png}
%  \caption{The same system solving 3x3 Lights-Out game. (Top: Original results) (Bottom: Rounded to 0/1)}
% \end{figure}
