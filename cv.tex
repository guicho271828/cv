...
\emph{Recent work focuses on LLM-based reasoning, inference-time scaling, and algorithmic guarantees while using LLMs.}
...
\begin{CV}
 \item[10/2024] ECAI Outstanding Paper Award, 27th European Conference on Artificial Intelligence.

 \item[06/2022] ICAPS 2022 Outstanding PC and SPC Award (Outstanding Program Committee Members).

 \item[04/2016--] Research Fellow (DC2), Japan Society for the Promotion of Science. (Equivalent of NSF Grant in Japan)
 \item[03/2017]
