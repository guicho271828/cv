...
with a strong emphasis on Bayesian generative modeling.
(1) \red{Automatic identification of discrete symbolic representation for planning}, i.e.,
symbol grounding and knowledge acquisition using deep learning and Bayesian generative modeling.
(2) \blue{Learning the search policy / heuristic guidance} for problem solving and enhancing search efficiency.
(3) \green{Statistically well-motivated search algorithms} inspired from Multi-Armed Bandits and Bayesian inference.
